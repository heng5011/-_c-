    ...
    <form id="form1" runat="server">
        <div align="center"; div style="text-align: center">
            <table align="center"; table style="width: 755px" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="3" rowspan="2" style="height: 477px; background-image: url(../../Images/skin/bg.jpg); width: 768px; vertical-align: middle; text-align: center;">
                        <table align="center"; table style="left: 0px; width: 546px; vertical-align: top;" cellpadding="0" cellspacing="0">
                            <tr>
                                <td colspan="3" style="height: 31px; width: 582px;">
                                    <span style="color: #993300"><strong>文章信息管理</strong></span></td>
                            </tr>
                            <tr>
                                <td colspan="3" rowspan="2" style="height: 219px; width: 582px;">
                                    <table style="width: 510px">
                                        ...
                                        <tr>
                                            <td colspan="6" rowspan="2" style="height: 156px; vertical-align: top; text-align: center;">
