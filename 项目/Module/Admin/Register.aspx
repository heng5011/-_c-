...
<body style="text-align: center; margin-top: 0px; padding-top: 0px;" text="#00"; background="../../Images/skin/background5.jpg">
    ...
    <div style="text-align: center; vertical-align: top;" align="center">
        <table align="center"; table style="width: 755px" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="3" style="text-align: center; height: 465px; background-image: url(../../Images/skin/bg.jpg); background-repeat: no-repeat;">
                    <table style="border-right: black thin solid; border-top: black thin solid; border-left: black thin solid;
                        width: 392px; border-bottom: black thin solid; vertical-align: top;" id="TABLE1" runat="server" align="center">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1" style="width: 173px; height: 21px; text-align: left; font-size: 12pt;">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Font-Size="9pt" ControlToValidate="txtName" ErrorMessage="用户名不能为空">*</asp:RequiredFieldValidator></td>
                        </tr>
                        ...
                        <tr style="font-size: 12pt">
                            ...
                            <td colspan="2" style="width: 16px; height: 21px; text-align: center; font-size: 9pt;">
                                <asp:TextBox ID="txtPwd" runat="server" Width="117px" TextMode="Password" 
                        ...
                        <tr>
                            <td colspan="4" style="height: 21px; text-align: center">
                                ...
                                <asp:Button ID="btnBack" runat="server" Text="取消" Font-Size="9pt" OnClick="btnBack_Click" CausesValidation="False" /><br />
