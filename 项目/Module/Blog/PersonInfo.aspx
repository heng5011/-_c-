...
<body style="margin-top: 0px; padding-top: 0px"; background="../../Images/skin/background7.jpg">
    ...
    <div style="text-align: center">
        <table align="center"; table style="width: 755px; text-align: center" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="3" style="height: 131px">
                    <uc2:BlogHeader id="BlogHeader1" runat="server">
                    </uc2:BlogHeader></td>
            </tr>
            <tr>
                <td align="center" colspan="3" style="height: 477px; text-align: center; background-image: url(../../Images/Skin/bg.jpg);">
                    <table align="center"; table style="border-right: black thin solid; border-top: black thin solid; border-left: black thin solid;
